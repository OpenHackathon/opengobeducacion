...
* @version 1.0
*/  
class EFullCalendarHeart extends CWidget
{
    ...
    {        
        $assetsDir=dirname(__FILE__).DIRECTORY_SEPARATOR."fullcalendar-2.0.0-beta2";
        ...
        //$cs->registerScriptFile($assets.'/lib/lang-all.js');
