...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Open Gob</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Datos Abiertos">
    <meta name="author" content="Datos Abiertos">
	...
	<?php  
      ...
      <!-- styles for style switcher -->
        ...
        <link rel="stylesheet" type="text/css" media="screen" title="style8" href="<?php echo $baseUrl;?>/css/style.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $baseUrl;?>/js/jquery-validation/demo/css/screen.css" />
    	<?php
        ...
        $cs->registerScriptFile($baseUrl.'/js/jquery-validation/dist/jquery.validate.js'); 
        $cs->registerScriptFile($baseUrl.'/js/jquery-validation/dist/localization/messages_es_AR.js'); 
        
        
        Yii::app()->getClientScript()->registerCoreScript( 'jquery.ui' );
        Yii::app()->clientScript->registerCssFile(Yii::app()->clientScript->getCoreScriptUrl().'/jui/css/base/jquery-ui.css');

        //$cs->registerScriptFile($baseUrl.'/js/highcharts/js/highcharts.js');
        //$cs->registerScriptFile($baseUrl.'/js/highcharts/js/modules/exporting.js');     
        ?>
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl.'/js/jquery.popupWindow.js'; ?>"></script>
...
<?php require_once('tpl_footer.php') ?>
 ...
 <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8RhQzylNLWXudsifFQXfkwH4Y-XGVqpk&signed_in=true&callback=initMap"></script>